function Kit({
  ...
  return React.createElement("svg", {
    ...
    offset: "0",
    stopColor: "rgba(255,255,255,.08)"
  }), React.createElement("stop", {
    offset: "1",
    stopColor: "rgba(0,0,0,.15)"
    ...
    height: "105",
    fill: primary
  }), design === "stripes" && React.createElement("g", null, [0, 1, 2, 3, 4, 5].map(i => React.createElement("rect", {
    key: i,
    x: i * 18,
    y: "0",
    width: "9",
    ...
    fill: secondary,
    opacity: ".95"
  }))), design === "sash" && React.createElement("polygon", {
    points: "-5,40 60,-5 105,25 25,95",
    fill: secondary
  }), design === "halves" && React.createElement("rect", {
    x: "50",
    y: "0",
    width: "55",
    height: "105",
    fill: secondary
  }), design === "hoops" && React.createElement("g", null, [0, 1, 2, 3].map(i => React.createElement("rect", {
    key: i,
    x: "0",
    y: 20 + i * 22,
    width: "100",
    ...
    d: "M20,10 L35,4 C40,12 60,12 65,4 L80,10 L95,22 L82,38",
    fill: "none",
    stroke: "rgba(0,0,0,.25)",
    strokeWidth: ".6"
  }), React.createElement("path", {
    d: "M20,10 L5,22 L18,38",
    fill: "none",
    stroke: "rgba(0,0,0,.25)",
    strokeWidth: ".6"
  }), React.createElement("path", {
    d: "M35,4 C40,12 60,12 65,4",
    fill: "none",
    stroke: "rgba(0,0,0,.3)",
    strokeWidth: ".8"
  }), React.createElement("path", {
    ...
    return React.createElement("text", {
      ...
      fontSize: "38",
      fill: light ? "rgba(255,255,255,.95)" : "rgba(18,24,26,.95)",
      style: {
        paintOrder: "stroke",
        stroke: light ? "rgba(0,0,0,.55)" : "rgba(255,255,255,.65)",
        strokeWidth: 1.6
      }
    }, number);
...
function Crest({
  ...
  return React.createElement("svg", {
    ...
    height: "106",
    fill: primary
  }), design === "stripes" && [0, 1, 2, 3, 4, 5].map(i => React.createElement("rect", {
    key: i,
    x: i * 18,
    y: "0",
    width: "9",
    ...
    fontWeight: "700",
    fontSize: labelSize,
    fill: window.contrastTextMixed(primary, secondary, design),
    style: {
      paintOrder: "stroke",
      stroke: window.contrastTextMixed(primary, secondary, design) === "#ffffff" ? "rgba(0,0,0,.5)" : "rgba(255,255,255,.6)",
      strokeWidth: 1.2
    }
