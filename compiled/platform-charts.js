...
function RadarChart({
  ...
  }, [1, 0.7, 0.4].map(f => React.createElement("polygon", {
    key: f,
  ...
  }), valuePts.map((p, i) => React.createElement("circle", {
    key: i,
    cx: p[0],
    cy: p[1],
    r: "3",
...
function Sparkline({
  ...
  if (!values.length) return React.createElement("svg", {
    width: width,
    height: height
  });
...
function EvolutionChart({
  ...
  if (points.length < 2) return React.createElement("div", {
    className: "empty-state sm"
  }, "Necesit\xE1s al menos 2 evaluaciones para ver la evoluci\xF3n.");
  ...
  return React.createElement("svg", {
  ...
  }, [0, 0.33, 0.66, 1].map(f => React.createElement("line", {
    key: f,
    x1: padL,
    y1: padT + innerH * f,
    x2: width - padR,
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round"
  }), coords.map((c, i) => React.createElement("circle", {
    key: i,
    cx: c[0],
    cy: c[1],
...
//# sourceURL=src/platform-charts.jsx
