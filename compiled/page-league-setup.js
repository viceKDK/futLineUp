...
function detectLeagueCsvDelimiter(text) {
  ...
  for (let i = 0; i < firstLine.length; i += 1) {
    ...
    if (char === '"') {
      if (quoted && firstLine[i + 1] === '"') i += 1;else quoted = !quoted;
      continue;
    }
...
function downloadLeagueCsvExample(type) {
  ...
  const csv = fixture ? "Fecha,Local,Visitante,Goles Local,Goles Visitante\n2026-08-22,Los Pibes,La Banda,2,1\n2026-08-29,La Banda,El Barrio,,\n" : "Equipo\nLos Pibes\nLa Banda\nEl Barrio\nDeportivo Centro\n";
...
function LeagueSetupScreen({
  ...
  const removeTeam = team => {
    const used = baseFixtures.some(fixture => fixture.home === team || fixture.away === team);
    if (used) {
  ...
  return leagueEl("div", {
  ...
  }, leagueEl("div", null, leagueEl("div", {
    className: "page-kicker"
  }, editing ? "Configurar competencia" : "Nueva competencia"), leagueEl("h1", null, editing ? "Equipos de la liga" : "Crear liga"), leagueEl("p", null, "Definí los participantes una vez. La tabla, el fixture y la copa quedan separados de las demás ligas.")), onCancel && leagueEl("button", {
    className: "btn ghost",
    type: "button",
    onClick: onCancel
  }, "Cancelar")), leagueEl("div", {
    className: "league-setup-grid"
  }, leagueEl("section", {
    className: "card league-setup-card"
  }, leagueEl("div", {
    className: "league-setup-step"
  }, "1", leagueEl("span", null, "Datos de la liga")), leagueEl("div", {
    className: "league-setup-fields"
  }, leagueEl("label", {
    className: "field"
  }, leagueEl("span", null, "Nombre"), leagueEl("input", {
    value: name,
  ...
  }, leagueEl("span", null, "Temporada"), leagueEl("input", {
    value: season,
    onChange: event => setSeason(event.target.value),
    placeholder: "2026"
  }))), leagueEl("div", {
    className: "league-setup-step second"
  }, "2", leagueEl("span", null, "Participantes")), leagueEl("div", {
    ...
    onClick: addTeam
  }, "Agregar")), leagueEl("div", {
    className: "league-team-list"
  }, ...teams.map((team, index) => leagueEl("div", {
    className: "league-team-chip",
    key: team
  }, leagueEl("span", {
    className: "league-team-number"
  }, index + 1), leagueEl("strong", null, team), leagueEl("button", {
    type: "button",
    onClick: () => removeTeam(team),
    "aria-label": `Quitar ${team}`
  }, "×"))), !teams.length && leagueEl("div", {
    className: "league-empty-teams"
  }, "Todavía no agregaste equipos."))), leagueEl("section", {
    className: "card league-import-card"
  }, leagueEl("div", {
    className: "league-setup-step"
  }, "CSV", leagueEl("span", null, "Importación rápida")), leagueEl("h2", null, "Traé la liga desde una planilla"), leagueEl("p", {
    className: "league-import-copy"
  }, "Podés importar solo equipos o un fixture completo. Si el CSV trae goles, esos partidos entran como jugados y la tabla se calcula al crear la liga."), leagueEl("input", {
    ref: fileInputRef,
    className: "league-file-input",
    type: "file",
    accept: ".csv,text/csv",
    onChange: importCsvFile
  }), leagueEl("button", {
    type: "button",
    className: "league-dropzone",
    onClick: () => fileInputRef.current?.click()
  }, leagueEl("strong", null, "Importar CSV"), leagueEl("span", null, "Equipo  ·  o  ·  Fecha, Local, Visitante, Goles Local, Goles Visitante")), leagueEl("div", {
    className: "league-example-actions"
  }, leagueEl("button", {
    type: "button",
    className: "link-btn",
    onClick: () => downloadLeagueCsvExample("teams")
  }, "Ejemplo de equipos ↓"), leagueEl("button", {
    type: "button",
    className: "link-btn",
    onClick: () => downloadLeagueCsvExample("fixture")
  }, "Ejemplo de fixture ↓")), importInfo && leagueEl("div", {
    className: "league-import-result"
  }, leagueEl("strong", null, importInfo.file), leagueEl("span", null, `${importInfo.teams} equipos${importInfo.fixtures ? ` · ${importInfo.fixtures} partidos` : ""}`), importInfo.warnings.length > 0 && leagueEl("small", null, `${importInfo.warnings.length} fila(s) ignoradas por datos incompletos o inválidos.`)), leagueEl("div", {
    className: "league-csv-help"
  }, leagueEl("strong", null, "Columnas aceptadas"), leagueEl("span", null, "Equipos: Equipo / Team / Nombre / Club"), leagueEl("span", null, "Fixture: Fecha, Local, Visitante, Goles Local, Goles Visitante"), leagueEl("span", null, "También acepta ; o tabulaciones y campos entre comillas.")))), error && leagueEl("div", {
  ...
  }, leagueEl("strong", null, teams.length), leagueEl("span", null, teams.length === 1 ? "equipo" : "equipos"), leagueEl("i", null, "·"), leagueEl("strong", null, baseFixtures.length + importedFixtures.length), leagueEl("span", null, "partidos")), leagueEl("button", {
    type: "button",
    className: "btn primary league-create-btn",
    onClick: submit
  }, editing ? "Guardar cambios" : "Crear liga")));
}
...
function LeagueWorkspace() {
  ...
  }, leagueEl("div", null, leagueEl("strong", null, activeCompetition?.name || "Liga"), leagueEl("span", null, `${activeTeams.length} participantes propios de esta competencia`)), leagueEl("div", {
    className: "league-workspace-buttons"
  }, leagueEl("button", {
    type: "button",
    className: "btn ghost sm",
    onClick: () => setSetupMode("edit")
  }, "Editar equipos"), leagueEl("button", {
    type: "button",
...
//# sourceURL=src/page-league-setup.jsx
