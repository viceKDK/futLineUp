...
window.ICON_PATHS = {
  ...
  editorNav: [
    "M3 5h18v14H3V5",
    "M12 5v14M12 9.5a2.5 2.5 0 100 5 2.5 2.5 0 000-5",
  ],
  shuffle: [
    "M16 4h4v4M20 4l-6.2 6.2M4 20l5.2-5.2M16 20h4v-4M20 20l-6.2-6.2M4 4l5.2 5.2",
  ],
  ...
  shareNodes: [
    "M18 4a2.2 2.2 0 100 4.4A2.2 2.2 0 0018 4M6 9.8a2.2 2.2 0 100 4.4 2.2 2.2 0 000-4.4M18 15.6a2.2 2.2 0 100 4.4 2.2 2.2 0 000-4.4",
    "M8 11l8-4.2M8 13l8 4.2",
  ],
  vest: [
    "M9 4.5a3 3 0 016 0H18a1 1 0 011 1V20a1 1 0 01-1 1H6a1 1 0 01-1-1V5.5a1 1 0 011-1h3z",
    "M9 12h6M9 16h4",
  ],
  trophy: [
    "M8 4h8v6a4 4 0 01-8 0V4z",
    "M8 5H5a3 3 0 003 4.5M16 5h3a3 3 0 01-3 4.5M12 14v4M8 20h8",
  ],
  account: [
    "M12 5a3.2 3.2 0 100 6.4A3.2 3.2 0 0012 5",
    "M5.5 20a6.5 6.5 0 0113 0",
  ],
  ...
  gear: [
    "M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7",
...
function GoogleG({ size = 18 }) {
  return (
    ...
    >
      ...
      <path
        fill="#FBBC05"
        d="M10.5 19.3A14.5 14.5 0 009.8 24c0 1.7.3 3.3.7 4.7l-7.9 6.1A24 24 0 010 24c0-3.9.9-7.5 2.6-10.8l7.9 6.1z"
      />
      <path
        fill="#34A853"
        d="M24 48c6.4 0 11.8-2.1 15.7-5.7l-7.3-5.7c-2 1.4-4.7 2.3-8.4 2.3-6.3 0-11.6-3.6-13.5-8.8l-7.9 6.1C6.5 42.6 14.6 48 24 48z"
      />
    </svg>
  );
}
