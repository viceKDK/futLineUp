  ...
  return (
    ...
    >
      ...
      {showNumber &&
        ...
        (() => {
          const light =
            window.contrastTextMixed(primary, secondary, design) === "#ffffff";
          return (
            <text
              x="50"
              y="72"
      ...
      <g clipPath={`url(#crest-clip-${id})`}>
        {photo ? (
          ...
          <>
            ...
            {design === "sash" && (
              <polygon points="-5,42 60,-5 105,26 25,96" fill={secondary} />
            )}
            {design === "halves" && (
              <rect x="50" y="0" width="55" height="106" fill={secondary} />
            )}
            ...
            <text
              ...
              style={{
                paintOrder: "stroke",
                stroke:
                  window.contrastTextMixed(primary, secondary, design) ===
                  "#ffffff"
                    ? "rgba(0,0,0,.5)"
                    : "rgba(255,255,255,.6)",
                strokeWidth: 1.2,
