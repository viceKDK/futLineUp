...
17. **Fix: tap-to-swap en la cancha**: el intercambio de jugadores ya colocados dependía solo del drag & drop nativo del navegador sobre SVG, que es poco confiable (se verificó que la lógica de swap funcionaba, pero el gesto de arrastre nativo fallaba seguido). Ahora se puede tocar una posición ocupada y después otra para intercambiarlas, sin depender del drag nativo — más confiable en mouse, trackpad y pantallas táctiles.
